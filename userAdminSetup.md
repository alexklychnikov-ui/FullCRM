...
Документ для администратора организации: первичный вход, модули, аналитика и интеграции.
...
| Аналитика (пороги) | `/settings` (вкладка по умолчанию) |
...
1. Модуль Коммуникации включён.  
2. На карточке контакта/сделки создайте сообщение с каналом **email**.  
3. Оно попадёт в timeline и EventLog.

Это не замена почтового ящика — только фиксация переписки в CRM.
